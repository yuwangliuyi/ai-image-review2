...
INSERT INTO "new_Archive" ("archivedAt", "category", "countryStyle", "department", "id", "imageCount", "spuId", "spuName", "uploadedByName") SELECT "archivedAt", "category", "countryStyle", "department", "id", "imageCount", "spuId", "spuName", "uploadedByName" FROM "Archive";
DROP TABLE "Archive";
...
INSERT INTO "new_Spu" ("assignedReviewerId", "category", "countryStyle", "createdAt", "department", "id", "name", "status", "updatedAt", "uploadedById") SELECT "assignedReviewerId", "category", "countryStyle", "createdAt", "department", "id", "name", "status", "updatedAt", "uploadedById" FROM "Spu";
DROP TABLE "Spu";
